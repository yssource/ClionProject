...
static void json_get()
{
    ...
    client.request(methods::GET, builder.to_string())  // continue when the response is available
            ...
            .then([](pplx::task<json::value> previousTask) {   // continue when the JSON value is available
